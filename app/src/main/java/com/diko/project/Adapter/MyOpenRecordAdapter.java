...
import com.diko.project.Module.SetLockOpenLockRecordModule;
...
public class MyOpenRecordAdapter extends BaseAdapter {
    private Vector<SetLockOpenLockRecordModule> vector;
    ...
    public MyOpenRecordAdapter(Context context, Vector<SetLockOpenLockRecordModule> v) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (vector.get(position).time.equals("今天") || vector.get(position).time.equals("最近三天") || vector.get(position).time.equals("最近一周") || vector.get(position).time.equals("其他")) {
            ...
            holder.textView2.setText(StringToDate.times(vector.get(position).time + "000"));
            Log.e("holdertextView2: ", vector.get(position).getTime() + "000");
            Log.e("holdertextView2change: ", StringToDate.times(vector.get(position).time + "000"));
        }
        return convertView;
    }
