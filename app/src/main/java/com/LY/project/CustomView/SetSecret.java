...
public class SetSecret extends LinearLayout implements View.OnClickListener,TextWatcher,View.OnKeyListener{
    EditText e1;
    EditText e2;
    EditText e3;
    EditText e4;
    ...
    public SetSecret(Context c, AttributeSet as){
        super(c,as);
        this.c=c;
        LayoutInflater.from(c).inflate(R.layout.view_secret,this,true);
        ...
        e7.addTextChangedListener(this);
        e8.addTextChangedListener(this);
    ...
    public String getText(){
        return e1.getText().toString()+e2.getText().toString()+e3.getText().toString()+e4.getText().toString()+e5.getText().toString()+e6.getText().toString()+e7.getText().toString()+e8.getText().toString();
    }
    @Override
    ...
    public void onTextChanged(CharSequence s, int start, int before, int count) {
        if(s.toString().length()==1){
            if(e1.isFocused()){
                ...
                e6.clearFocus();
                if(e7.getText().toString().length()==1)
                    e7.setText("");
                e7.requestFocus();
            }
            else if(e7.isFocused()){
                e7.clearFocus();
                if(e8.getText().toString().length()==1)
                    e8.setText("");
                e8.requestFocus();
            }
